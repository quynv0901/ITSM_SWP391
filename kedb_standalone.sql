...
-- Máy chủ (ci_id 1–8)
('Máy chủ Web Ứng dụng 01',        'Hardware', 'Ubuntu 22.04 LTS',     'Máy chủ web chính chạy giao diện hệ thống ITSM',              9, 5, 1, 'ACTIVE'),
('Máy chủ Web Ứng dụng 02',        'Hardware', 'Ubuntu 22.04 LTS',     'Máy chủ web dự phòng cho tính sẵn sàng cao',                  9, 5, 1, 'ACTIVE'),
('Máy chủ Cơ sở dữ liệu chính',    'Hardware', 'Ubuntu 20.04 LTS',     'Máy chủ MySQL chính phục vụ nền tảng ITSM',                   9, 5, 1, 'ACTIVE'),
('Máy chủ Email (Exchange)',        'Hardware', 'Windows Server 2019',  'Máy chủ Microsoft Exchange nội bộ',                           9, 1, NULL, 'ACTIVE'),
('Máy chủ Giám sát',               'Hardware', 'CentOS 8',             'Chạy Prometheus, Grafana và hệ thống cảnh báo',               9, 5, NULL, 'ACTIVE'),
('Máy chủ Phát triển / Kiểm thử',  'Hardware', 'Ubuntu 20.04 LTS',     'Môi trường sandbox dùng chung cho phát triển và QA',          9, 3, NULL, 'ACTIVE'),
('Thiết bị lưu trữ Sao lưu NAS',   'Hardware', 'Synology DSM 7.2',     'Thiết bị NAS 40TB dùng cho sao lưu tự động hàng ngày',        9, 5, NULL, 'ACTIVE'),
('Máy chủ Staging cũ',             'Hardware', 'CentOS 6',             'Máy chủ staging đã ngưng hoạt động, chờ thu hồi phần cứng',  9, 5, NULL, 'RETIRED'),
-- Thiết bị mạng (ci_id 9–16)
('Switch Lõi - Tầng 1',            'Network',  'Cisco IOS 15.2',       'Switch 48 cổng quản lý cho máy trạm tầng 1',                  9, 2, 3, 'ACTIVE'),
('Switch Lõi - Tầng 2',            'Network',  'Cisco IOS 15.2',       'Switch 48 cổng quản lý cho máy trạm tầng 2',                  9, 2, 3, 'ACTIVE'),
('Tường lửa (Vành đai)',            'Network',  'Fortinet FortiOS 7.4', 'Tường lửa vành đai bảo vệ DMZ và mạng nội bộ',               9, 2, NULL, 'ACTIVE'),
('Điểm truy cập WiFi - Hội nghị',  'Network',  'Cisco Aironet 2800',   'Access point riêng cho phòng họp',                            9, 2, 3, 'ACTIVE'),
('Điểm truy cập WiFi - Văn phòng', 'Network',  'Cisco Aironet 2800',   'Access point phủ sóng toàn bộ khu vực văn phòng mở',         9, 2, 3, 'ACTIVE'),
('Cổng VPN',                       'Network',  'Cisco ASA 5506-X',     'Cổng VPN công ty hỗ trợ Cisco AnyConnect',                    9, 2, 3, 'ACTIVE'),
('Router Khu A',                   'Network',  'Cisco IOS V2',         'Thiết bị định tuyến chính cho khu vực văn phòng A',           9, 2, 3, 'ACTIVE'),
('Modem ADSL cũ',                  'Network',  'TP-Link TD-8817',      'Kết nối internet dự phòng cũ, không còn là kết nối chính',   9, 2, NULL, 'INACTIVE'),
-- Phần mềm / Dịch vụ (ci_id 17–26)
('Ứng dụng Web ITSM',              'Software', 'v2.4.1',               'Nền tảng Quản lý Dịch vụ IT (hệ thống này)',                  9, 1, 2, 'ACTIVE'),
('Jira Software',                  'Software', 'v9.12.0',              'Theo dõi dự án và vấn đề cho đội phát triển',                 9, 3, NULL, 'ACTIVE'),
('MySQL Database (Chính)',          'Software', '8.0.36',               'Cơ sở dữ liệu quan hệ chính cho ứng dụng ITSM',               9, 5, NULL, 'ACTIVE'),
('MySQL Database (Bản sao đọc)',    'Software', '8.0.36',               'Bản sao đọc phục vụ báo cáo và dự phòng',                    9, 5, NULL, 'ACTIVE'),
('Prometheus',                     'Software', 'v2.51.0',              'Hệ thống thu thập chỉ số và giám sát chuỗi thời gian',        9, 5, NULL, 'ACTIVE'),
('Grafana',                        'Software', 'v10.4.0',              'Giao diện trực quan hóa chỉ số từ Prometheus',                9, 5, NULL, 'ACTIVE'),
('Nginx (Reverse Proxy)',           'Software', 'v1.26.0',              'Reverse proxy và kết thúc SSL cho các dịch vụ web',           9, 5, NULL, 'ACTIVE'),
('GitLab CE',                      'Software', 'v16.11',               'Máy chủ Git nội bộ và pipeline CI/CD',                       9, 3, NULL, 'ACTIVE'),
('Cisco AnyConnect Client',        'Software', 'v4.10.08029',          'Phần mềm VPN của công ty cài trên máy tính nhân viên',        9, 1, 3, 'ACTIVE'),
('Microsoft 365 (Exchange Online)', 'Service', 'N/A',                  'Bộ công cụ email và cộng tác đám mây cho toàn bộ nhân viên',  9, 1, NULL, 'ACTIVE'),
-- Đã ngưng / Loại bỏ (ci_id 27–29)
('Máy in Văn phòng cũ',            'Hardware', 'HP LaserJet 2005',     'Máy in đã ngưng hoạt động, không còn được sử dụng',          9, 1, NULL, 'INACTIVE'),
('Cổng VPN cũ (OpenVPN)',           'Software', 'v2.4.9',               'Đã được thay thế bởi Cisco AnyConnect, không còn dùng',      9, 2, NULL, 'RETIRED'),
('Domain Controller 2008 R2',      'Hardware', 'Windows Server 2008 R2','Máy chủ domain đã ngưng hoạt động, đã tháo phần cứng',      9, 5, 1, 'RETIRED');
