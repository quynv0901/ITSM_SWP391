                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <%-- BẢNG ĐIỀU KHIỂN --%>
                            ...
                            <%-- HỆ THỐNG --%>
                                <c:if
                                    test="${sessionScope.user.roleId == 10 || sessionScope.user.roleId == 3 || sessionScope.user.roleId == 5}">
                                    ...
                                    <%-- HẠ TẦNG & TÀI SẢN --%>
                                        ...
                                        <%-- DỊCH VỤ --%>
                                            ...
                                            <c:set var="serviceUrl"
                                                value="${roleId == 1 ? '/service-catalog' : (roleId == 3 ? '/service-request' : '/admin-services')}" />
                                            <li>
                    ...
                    <div class="topbar">
                        <div class="topbar-left">
                            ...
                            <span class="fw-bold">
                                <c:choose>
                                    <c:when
                                        test="${pageContext.request.requestURI.contains('/dashboard') and !pageContext.request.requestURI.contains('/sla-dashboard')}">
                                        Bảng điều khiển</c:when>
                                    <c:when test="${pageContext.request.requestURI.contains('/admin/users')}">Quản lý
                                        người dùng</c:when>
                                    <c:when test="${pageContext.request.requestURI.contains('/admin/departments')}">Quản
                                        lý phòng ban</c:when>
                                    <c:when test="${pageContext.request.requestURI.contains('/admin/knowledge-base')}">
                                        Quản lý bài viết</c:when>
                                    <c:when
                                        test="${pageContext.request.requestURI.contains('/admin/knowledge-article')}">
                                        Quản lý cơ sở kiến thức</c:when>
                                    <c:when test="${pageContext.request.requestURI.contains('/ticket-category')}">Danh
                                        mục Ticket</c:when>
                        ...
                        <div class="topbar-right">
                            ...
                            <div class="dropdown me-3">
                                <a class="badge-notification text-decoration-none text-white" id="notificationDropdown"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end shadow border-0 notification-dropdown pt-0"
                                    ...
                                    <li
                                        class="dropdown-header d-flex justify-content-between align-items-center bg-light border-bottom pt-2 pb-2">
                                    ...
                                    <li class="bg-light px-2 pt-2 border-bottom">
                                        <ul class="nav nav-tabs nav-justified border-0" id="notificationTabs"
                                            role="tablist" style="font-size: 0.85rem;">
                                            <li class="nav-item">
                                                <button class="nav-link active py-2 fw-semibold" id="nav-task-tab"
                                                    data-bs-toggle="tab" data-bs-target="#nav-task" type="button"
                                                    role="tab"
                                                    style="border:none; border-bottom: 2px solid transparent;"
                                                    onclick="event.stopPropagation();">Nhiệm vụ <span
                                                        class="badge bg-danger ms-1" id="badge-task"
                                                        style="display:none;">0</span></button>
                                            </li>
                                            <li class="nav-item">
                                                <button class="nav-link py-2 fw-semibold" id="nav-system-tab"
                                                    data-bs-toggle="tab" data-bs-target="#nav-system" type="button"
                                                    role="tab"
                                                    style="border:none; border-bottom: 2px solid transparent;"
                                                    onclick="event.stopPropagation();">Hệ thống <span
                                                        class="badge bg-danger ms-1" id="badge-system"
                                                        style="display:none;">0</span></button>
                                            </li>
                                        </ul>
                                    </li>
