...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-primary">
            <i class="bi bi-journal-bookmark-fill me-2"></i>Cơ sở kiến thức chi tiết
        </h2>
    ...
    <div class="row g-4">
            ...
            <c:if test="${not empty article.symptom or not empty article.cause or not empty article.solution or not empty article.errorCode}">
                <div class="card card-custom p-4 hover-card">
                    ...
                    <c:if test="${not empty article.errorCode}">
                        <div class="mb-3">
                            <div class="section-title">Mã lỗi</div>
                            <a href="${pageContext.request.contextPath}/known-error" class="text-decoration-none">
        ...
        <div class="col-lg-4">
            <div class="card card-custom p-4 hover-card">
                <h5 class="fw-bold mb-3">
                    <i class="bi bi-info-circle-fill me-2"></i>Thông tin bài viết
                </h5>
                ...
                <div class="mb-3">
                    ...
                    <span class="badge bg-info-subtle text-dark badge-soft">Cơ sở kiến thức</span>
                </div>
