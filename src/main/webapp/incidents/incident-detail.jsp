            ...
            <%@ taglib prefix="fn" uri="jakarta.tags.functions" %>
                ...
                <div class="incident-detail-page container-fluid bg-white p-4 rounded shadow-sm">
                    ...
                    <div class="page-header">
                        <a href="${pageContext.request.contextPath}/incident?action=list" class="back-btn">&#8592; Quay
                            lại
                            danh sách</a>
                    ...
                    <c:if test="${param.editError eq 'locked'}">
                        <div class="alert alert-error">Bạn không thể chỉnh sửa incident này vì trạng thái đã được
                            Agent/Expert cập nhật.</div>
                    </c:if>
                    ...
                    <c:if test="${not empty param.error and param.error eq 'invalidCancelReason'}">
                        <div class="alert alert-error">Lý do hủy không hợp lệ (5-500 ký tự, không chứa ký tự nguy hiểm).
                        </div>
                    </c:if>
                    ...
                    <div class="card">
                        ...
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                ...
                                <span>
                                    <c:choose>
                                        <c:when test="${not empty incident.reportedByName}">${incident.reportedByName}
                                        </c:when>
                            ...
                            <div class="detail-item">
                                ...
                                <c:choose>
                                    ...
                                    <c:otherwise>
                                        <span>
                                            <c:choose>
                                                <c:when test="${not empty incident.assignedToName}">
                                                    ${incident.assignedToName}</c:when>
                        ...
                        <div class="action-bar">
                            ...
                            <c:if
                                test="${not canCurrentUserEditIncident and sessionScope.user.userId == incident.reportedBy and sessionScope.user.roleId == 1}">
                                <span
                                    style="display:inline-flex;align-items:center;padding:9px 14px;border-radius:8px;background:#edf2f7;color:#4a5568;font-size:13px;font-weight:600;">
                            ...
                            <c:if
                                test="${incident.status eq 'PENDING' and sessionScope.user.userId == incident.reportedBy}">
                                <span
                                    style="display:inline-flex;align-items:center;padding:9px 14px;border-radius:8px;background:#fffaf0;color:#c05621;font-size:13px;font-weight:700;">
                            ...
                            <c:if
                                test="${incident.status eq 'PENDING' and (sessionScope.user.roleId == 2 or sessionScope.user.roleId == 5 or sessionScope.user.roleId == 10)}">
                                <button type="button" class="btn btn-danger"
                                    onclick="openAgentDecisionModal('APPROVE')">Approve hủy</button>
                                <button type="button" class="btn btn-warning"
                                    onclick="openAgentDecisionModal('REJECT')">Reject hủy</button>
                            </c:if>
                        ...
                        <c:if
                            test="${sessionScope.user.roleId == 1 and (incident.status eq 'RESOLVED' or incident.status eq 'CLOSED')}">
                            <div class="feedback-card">
                                <div class="card-title" style="margin-bottom:10px; border-bottom:0; padding-bottom:0;">
                                    Feedback sau xử lý</div>
                                <c:choose>
                                    <c:when test="${canGiveFeedback}">
                                        <form action="${pageContext.request.contextPath}/incident" method="post">
                                            ...
                                            <div class="feedback-stars">
                                                <label><input type="radio" name="rating" value="5" required> 5 - Rất hài
                                                    lòng</label>
                                                <label><input type="radio" name="rating" value="4"> 4</label>
                                                <label><input type="radio" name="rating" value="3"> 3</label>
                                                <label><input type="radio" name="rating" value="2"> 2</label>
                                                <label><input type="radio" name="rating" value="1"> 1 - Không hài
                                                    lòng</label>
                                            </div>
                                            <div class="form-group">
                                                <label for="feedbackText">Nội dung feedback (5-250 ký tự)</label>
                                                <textarea id="feedbackText" name="feedbackText"
                                                    class="feedback-textarea" maxlength="250" required
                                                    placeholder="Chia sẻ trải nghiệm xử lý vấn đề của bạn..."></textarea>
                                            </div>
                    ...
                    <c:if test="${sessionScope.user.roleId != 1}">
                        <div class="card" style="padding-bottom: 28px;">
                            <div class="tabs">
                                <button class="tab-btn active" onclick="switchTab('timelog', this)">&#9201; Nhật ký thời
                                    gian</button>
                                <button class="tab-btn" onclick="switchTab('related', this)">&#128279; Sự cố
                                    liên quan</button>
                                <button class="tab-btn" onclick="switchTab('comment', this)">&#128172; Bình luận nội
                                    bộ</button>
                            </div>
                                            ...
                                            <tbody>
                                                <c:forEach var="log" items="${timeLogs}" varStatus="s">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <c:choose>
                                                                <c:when test="${not empty log.agentName}">
                                                                    ${log.agentName}
                                                                </c:when>
                                        ...
                                        <form action="${pageContext.request.contextPath}/incident" method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group fg-time">
                                                    <label for="timeSpent">Số giờ <small
                                                            style="color:#718096;font-weight:normal;">(Tối đa
                                                            48h)</small></label>
                                                ...
                                                <div class="form-group fg-desc">
                                                    <label for="logDescription">Mô tả <small
                                                            style="color:#718096;font-weight:normal;">(Tối đa 200 ký tự,
                                                            tùy chọn)</small></label>
                                                    <input type="text" id="logDescription" name="logDescription"
                                                        maxlength="200"
                                                        placeholder="Bạn đã thực hiện công việc gì? (Có thể để trống)">
                                                    <div id="logDescRealtimeError"
                                                        style="color:#e53e3e; font-size:12px; margin-top:4px; display:none;">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                            ...
                                            <c:forEach var="inc" items="${relatedIncidents}">
                                                <li>
                                                    <div>
                                                        ...
                                                        <span
                                                            style="margin-left:10px; color:#4a5568;">${inc.title}</span>
                                                    </div>
                                                    <span
                                    ...
                                    <form action="${pageContext.request.contextPath}/incident" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group fg-desc" style="flex:1;">
                                                ...
                                                <input type="text" id="commentText" name="commentText" maxlength="1000"
                                                    placeholder="Mô tả cập nhật xử lý, phân tích lỗi, hướng xử lý tiếp theo..."
                                                    required>
                                            </div>
                                            <div class="form-group">
                                                <label>&nbsp;</label>
                                        ...
                                        <ul class="related-list">
                                            <c:forEach var="cmt" items="${comments}">
                                                <li style="display:block;">
                                                    ...
                                                    <div style="margin-top:8px;color:#4a5568;white-space:pre-wrap;">
                                                        ${cmt.commentText}</div>
                                                </li>
                                            </c:forEach>
                                        </ul>
                                    ...
                                    <c:otherwise>
                                        <div class="reason-group">
                                            ...
                                            <div class="reason-options">
                                                <div class="reason-option active"
                                                    onclick="selectReason('Tôi không cần hỗ trợ nữa')">
                                                    <input type="radio" name="cancelReason"
                                                        value="Tôi không cần hỗ trợ nữa" checked>
                                                    <span>Tôi không cần hỗ trợ nữa</span>
                                                </div>
                                                <div class="reason-option"
                                                    onclick="selectReason('Tôi đã tự giải quyết được')">
                                                    <input type="radio" name="cancelReason"
                                                        value="Tôi đã tự giải quyết được">
                                                    <span>Tôi đã tự giải quyết được</span>
                                                </div>
                                                <div class="reason-option"
                                                    onclick="selectReason('Tôi tạo nhầm ticket')">
                                                    <input type="radio" name="cancelReason" value="Tôi tạo nhầm ticket">
                                                    <span>Tôi tạo nhầm ticket</span>
                                                </div>
                                                <div class="reason-option"
                                                    onclick="selectReason('Vấn đề đã được giải quyết qua kênh khác')">
                                                    <input type="radio" name="cancelReason"
                                                        value="Vấn đề đã được giải quyết qua kênh khác">
                                        ...
                                        <div class="reason-detail" id="reasonDetail">
                                            ...
                                            <textarea id="reasonDetailText"
                                                placeholder="Vui lòng nhập lý do chi tiết..."></textarea>
                                        </div>
                                    </c:otherwise>
                                </c:choose>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-cancel" onclick="closeCancelModal()">Hủy
                                    bỏ</button>
                                <button type="button" class="btn btn-confirm" id="confirmCancelBtn"
                                    onclick="confirmCancel()">Xác nhận</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="reason-group">
                                    ...
                                    <textarea id="agentDecisionReason" class="form-control" style="min-height:90px;"
                                        placeholder="Nhập lý do để người dùng hiểu vì sao ticket bị hủy / bị từ chối..."></textarea>
                                    <div class="help-text">Lý do này sẽ được ghi lại để hiển thị cho End-user.</div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-cancel" onclick="closeAgentDecisionModal()">Hủy
                                    bỏ</button>
                                <button type="button" class="btn btn-confirm active" id="agentDecisionSubmit"
                                    onclick="submitAgentDecision()">Xác nhận</button>
                            </div>
                        </div>
                    </div>
