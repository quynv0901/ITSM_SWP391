...
<html lang="en">
    ...
    <body>
        ...
        <div class="error-container border-top border-danger border-5">
            ...
            <h1 class="h3 text-dark fw-bold mb-3">403 - Quyền truy cập bị từ chối</h1>
            <p class="text-muted mb-4">
                Rất tiếc! Bạn không có quyền truy cập trang này hoặc thực hiện hành động này.
                Chỉ những người có vai trò được ủy quyền mới có thể xem khu vực hạn chế này.
            </p>
