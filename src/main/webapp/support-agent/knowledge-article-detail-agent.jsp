...
<div class="container-fluid bg-white p-4 rounded shadow-sm">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="h4 text-primary m-0">
            <i class="bi bi-journal-text me-2"></i>Thông tin chi tiết
        </h2>
    ...
    <c:if test="${not empty article.symptom or not empty article.cause
        ...
        <div class="card border-0 shadow-sm mb-4">  <%-- thêm mb-4 --%>
            <div class="card-header bg-light fw-bold">
                <i class="bi bi-tools me-2 text-warning"></i>Thông tin kĩ thuật
            </div>
            <div class="card-body">
                        <c:if test="${not empty article.errorCode}">
                            <div class="mb-4">
                                <p class="text-uppercase text-muted mb-1" style="font-size:11px;letter-spacing:.06em;font-weight:600;">Mã lỗi</p>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <c:if test="${not empty article.tag}">
                        <div class="mb-3">
                            <label class="fw-bold text-muted small d-block">Thẻ</label>
