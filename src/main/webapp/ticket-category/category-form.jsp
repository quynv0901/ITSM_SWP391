    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
            ...
            <style>
                ...
                .diff-hints.diff-invalid .diff-btn {
                    border-color: #e53e3e !important;
                }
                                ...
                                <%-- Validation banner --%>
                                    ...
                                    <div class="f-row">
                                        <div class="f-group">
                                            ...
                                            <span class="f-error" id="err-categoryType"><i
                                                    class="bi bi-x-circle-fill"></i> <span
                                                    class="err-text"></span></span>
                                        </div>
                                        <div class="f-group">
                                            ...
                                            <select class="f-input" id="parentCategoryId" name="parentCategoryId">
                                                ...
                                                <c:forEach var="p" items="${allCats}">
                                                    <option value="${p.categoryId}" ${cat.parentCategoryId==p.categoryId
                                                        || param.parentId==p.categoryId ? 'selected' : '' }>
                                    ...
                                    <div class="f-group">
                                        ...
                                        <div class="f-footer">
                                            <span class="f-error" id="err-description"><i
                                                    class="bi bi-x-circle-fill"></i> <span
                                                    class="err-text"></span></span>
                                    ...
                                    <%-- Section: Routing / Difficulty --%>
                                        ...
                                        <div class="f-group">
                                            ...
                                            <div class="diff-hints" id="diffHints">
                                                <div class="diff-btn ${cat.difficultyLevel == 'LEVEL_1' ? 'sel-LEVEL_1' : ''}"
                                                    onclick="selectDiff('LEVEL_1')">
                                                    <div class="d-title" style="color:#27ae60;">Dễ</div>
                                                    <div class="d-sub">Nhiệm vụ tiêu chuẩn, tác động thấp.</div>
                                                </div>
                                                <div class="diff-btn ${cat.difficultyLevel == 'LEVEL_2' ? 'sel-LEVEL_2' : ''}"
                                                    onclick="selectDiff('LEVEL_2')">
                                                    <div class="d-title" style="color:#dd6b20;">Trung bình</div>
                                                    <div class="d-sub">Cần nhiều nỗ lực hơn.</div>
                                                </div>
                                                <div class="diff-btn ${cat.difficultyLevel == 'LEVEL_3' ? 'sel-LEVEL_3' : ''}"
                                                    onclick="selectDiff('LEVEL_3')">
                                                    <div class="d-title" style="color:#c53030;">Khó</div>
                                                    <div class="d-sub">Độ phức tạp cao hoặc tác động quan trọng.</div>
                                                </div>
                                            </div>
                                            <span class="f-error" id="err-difficultyLevel" style="margin-top:6px;"><i
                                                    class="bi bi-x-circle-fill"></i> <span
                                                    class="err-text"></span></span>
                                        </div>
                                                ...
                                                <div class="toggle-group">
                                                    <div class="form-check form-switch mb-0">
                                                        <input class="form-check-input" type="checkbox"
                                                            id="isActiveToggle" value="true" ${empty cat.categoryId ||
                                                            cat.active ? 'checked' : '' }>
                                                    </div>
                                                    <div>
                                                        <label class="mb-0 fw-semibold" for="isActiveToggle"
                                                            id="activeLbl" style="font-size:14px;">Active</label>
